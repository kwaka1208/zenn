...
3. シートに、以下の内容を記入します。
    ...
    - 送信者アドレス：From（送信元）に表示されるメールアドレスです。通常は空のままで構いません。指定できるメールアドレスは、Googleアカウントのエイリアスに設定されているアドレスのみです。詳しくは、Google公式のヘルプ「[別のアドレスやエイリアスからメールを送信する - Gmail ヘルプ](https://support.google.com/mail/answer/22370?hl=ja)」をご覧ください。
    - 件名：メールの件名
