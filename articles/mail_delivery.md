...
[まとめてメール送信](https://docs.google.com/spreadsheets/d/17IjqLLhnkbuocXuF2tykcLIn1kfBaues1aAwu-mUxns/copy?usp=sharing)
...
5. メニューの「拡張メニュー」から「メール送信」を選択してください。最初の１回目だけ実行の許可を求める表示が出ます。実行の許可を与えた後、もう一度「メール送信」を実行します。
