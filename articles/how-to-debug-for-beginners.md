...
#### 原因がわかったら修正方法を考えましょう
再現方法がわかれば原因もほぼわかったはずです。原因がわかれば、次に考えることは修正方法です。ひとつのバグの修正方法は多くの場合複数あります。この時、最初に思いついた修正方法を採用するのではなく、他にも考えられる修正方法がないかを考えてみましょう。ポイントは以下の通りです。
...
![](/images/how-to-debug-for-beginners/computer_businesswoman4_laugh.png)
