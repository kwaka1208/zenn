...
会議や飲み会の日程調整をする時、調整さんなどのクラウドツールを使ったことがある方は多いかと思います。「日程さん」はこういった日程調整機能をスプレッドシートで実現したものです。

一般的な日程調整サービスと違い、あらかじめ記入予定者の名前をいれておけるので、誰が未記入かを把握しやすいのが特徴です。

## 画面例

![](/images/find-a-date-time/sample.png =500x)
