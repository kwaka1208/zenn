---
title: 無料で使える各種素材や加工ツール（サービス）まとめ
emoji: 🧱
type: idea
topics: [sound, image, programming, materials]
published: true
---
## 概要
こちらには無料で使える各種素材や加工ツール（サービス）をまとめています。
利用にあたっては、各サイトの利用規約（利用許諾）の確認をお願いします。
...
- [Octions](https://primer.style/octicons/)
- [Noun Project](https://thenounproject.com)
- [Human Pictgram2.0](https://pictogram2.com/)
...
## スライド
- [パワポでデザイン](https://power-point-design.com)
- [パワーポイントのチラシテンプレート-パワポン](https://ppon.askul.co.jp/)
