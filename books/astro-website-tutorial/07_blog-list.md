...
ブラウザで `http://localhost:4321/blog/` を開くと、記事が新しい順に3件並んでいるはずです。コードのポイントを確認します。
...
保存すると、ヘッダーに「ブログ」が増えています。ヘッダーのコンポーネントには一切触っていません。第3章で「ナビゲーションはデータとして1か所にまとめる」設計にしておいた効果が、ここに表れています。
